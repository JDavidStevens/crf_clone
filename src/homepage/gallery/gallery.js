...
return(
    ...
    <div>
       <img src={CRF450RX} alt="CRF450RX"/>
       <img src={CRF250R} alt="CRF250R"/>
       <img src={CRF450L} alt="CRF450L"/>
       <img src={CRF250RX} alt="CRF250RX"/>
       <img src={CRF450X} alt="CRF450X"/>
       <img src={CRF450RWE} alt="CRF450RWE"/>
    </div>
    </div>
)
    }
